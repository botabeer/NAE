...
# -----------------------------
# Helper: safe display name retriever
# -----------------------------
...
# -----------------------------
# Message handler (with the "ignore non-number" behavior)
# -----------------------------
...
def handle_message(event):
    ...
    text_raw = getattr(event.message, "text", "") or ""
    text = text_raw.strip()
    ...
    if group_id and group_id in group_sessions and user_id in group_sessions[group_id]["players"]:
        ...
        if ans_num is None:
            # IGNORE invalid replies silently (no "الرجاء..." message)
            return
