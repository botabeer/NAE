...
أنت تعرف قيمة الحب والوفاء، وتحاول أن تجعل محيطك مليئًا بالإيجابية والدعم.
شجاعتك في مواجهة مشاعر الآخرين تجعلك صديقًا وشريكًا يعتمد عليه.""",
        "ب": """قلبك نقي لكنه حذر
...
تمتلك حساسية عالية تجاه الخيانة والكذب، وتبحث دائمًا عن الأمان العاطفي.
طبيعتك الحذرة تمنحك استقرارًا داخليًا، وتجعل علاقاتك أكثر متانة وصدقًا.""",
...
تمتلك قدرة على التفهم العميق لمشاعر الآخرين، وتتعاطف معهم بصدق.
هذا التوازن بين الحساسية والقوة يجعلك شخصًا نادرًا وملهمًا لمن حولك."""
    },
    "لعبة2": {
...
تمتلك قدرة كبيرة على مواجهة الضغوط وتحويلها إلى فرص.
عقلك متفتح وتتعلم من الأخطاء لتصبح نسخة أفضل من نفسك.""",
...
تستثمر مهاراتك الاجتماعية لبناء بيئة متعاونة وناجحة.
التواصل الفعال مع من حولك يجعلك مصدر دعم وإلهام.""",
...
تتعلم من تجاربك السابقة وتتخذ القرارات بحكمة.
هذه القدرة تمنحك قوة داخلية وثقة عالية بنفسك."""
    },
    "لعبة3": {
        "أ": """حب الأمان والثقة
...
تمتلك القدرة على بناء علاقة متينة ومستقرة، وتعطي الحب بدون شروط.
تسعى دائمًا لتجنب النزاعات والحفاظ على التوازن العاطفي.""",
        "ب": """حب المرح والضحك
...
تمتلك القدرة على إدخال البهجة في حياة من حولك.
شريكك يجد فيك مصدر إلهام وفرح دائم.""",
        "ج": """حب التفاهم والدعم
...
تتعلم كيفية إدارة الاختلافات بمرونة وحكمة.
تسعى دائمًا لتقديم الدعم العاطفي بطرق إيجابية ومؤثرة."""
    },
    "لعبة4": {
...
تعطي الأولوية لتنمية نفسك ومهاراتك.
تستمد القوة من الداخل أكثر من أي مصدر خارجي.""",
...
تستمتع بالحرية والمرونة في حياتك اليومية.
الحركة تمنحك شعورًا بالسيطرة والرضا الداخلي.""",
...
تمتلك حكمة تمكنك من اتخاذ القرارات الصائبة.
تشعر بالسكينة والطمأنينة حتى في أصعب الظروف."""
    },
    "لعبة5": {
        "أ": """طموح شخصي مستقل
...
تعتمد على مهاراتك ومواهبك للوصول إلى طموحاتك.
تسعى دائمًا لتحقيق الإنجازات الشخصية دون التنازل عن قيمك.""",
        "ب": """طموح اجتماعي
...
تعلم كيفية التوازن بين العمل الجماعي والمسؤولية الفردية.
تستفيد من دعم الآخرين لتحقيق نتائج أكبر.""",
        "ج": """طموح مدروس وواعٍ
...
تمتلك رؤية واضحة وأهدافًا محددة.
تعمل على تحقيق النجاح دون التسرع أو الإهمال."""
    },
    "لعبة6": {
...
تبحث عن أفضل الحلول دون الانفعال.
تمتلك قدرة عالية على تنظيم أفكارك واتخاذ القرارات الصحيحة.""",
...
تستخدم الحوار والتواصل لتطوير نفسك والآخرين.
تمتلك قدرة على بناء شبكة علاقات قوية وموثوقة.""",
...
تتمتع بصبر ومرونة عند مواجهة التحديات.
تعرف كيف تدير ضغوط الحياة بحكمة وهدوء."""
    },
    "لعبة7": {
        "أ": """صديق مخلص ومسؤول
...
أصدقاؤك يعتمدون عليك ويثقون بك في المواقف الصعبة.
تسعى دائمًا للحفاظ على روابط الصداقة القوية والمستقرة.""",
        "ب": """صديق مرح وممتع
...
تمتلك القدرة على كسر الروتين وإضفاء المتعة على حياتهم.
تجعل من حولك يشعرون بالراحة والسعادة.""",
        "ج": """صديق هادئ ومتفاهم
...
تقدم نصائح صادقة ومفيدة دون فرض رأيك.
تتمتع بالهدوء في التعامل مع الخلافات وتحافظ على توازن علاقاتك."""
    },
    "لعبة8": {
        "أ": """قرار سريع وواثق
...
تمتلك القدرة على التكيف مع المواقف المختلفة بسرعة.
تعرف متى تتحرك ومتى تنتظر لتحقيق أفضل النتائج.""",
...
تعرف قيمة العمل الجماعي في الوصول لحلول ناجحة.
تمتلك القدرة على بناء توافق بين الأشخاص المختلفين.""",
        "ج": """قرار مدروس وواعٍ
...
تستخدم المنطق والحدس معًا لاتخاذ أفضل قرار.
تتفادى التسرع وتضمن نتائج مستدامة."""
    },
    "لعبة9": {
        "أ": """حلم شخصي مستقل
...
تعمل على تحقيق الإنجازات بطريقة منظمة ومدروسة.
تتعلم من الفشل وتعتبره فرصة للتطور والنمو.""",
        "ب": """حلم اجتماعي
...
تسعى لبناء مجتمع أفضل من خلال جهودك ومبادراتك.
تساعد الآخرين على تحقيق طموحاتهم وتكون مصدر دعم دائم.""",
        "ج": """حلم متوازن وواعٍ
...
تمتلك القدرة على التخطيط بعناية لكل جانب من حياتك.
تسعى دائمًا لتحقيق النجاح دون التضحية بالعلاقات الاجتماعية."""
    },
    "لعبة10": {
        "أ": """سلام الانعزال الذاتي
...
تجد في العزلة فرصة لتطوير نفسك وتوضيح أهدافك.
تستمد القوة من الداخل وتعيش بسلام مع نفسك.""",
        "ب": """سلام النشاط والحركة
...
تستمتع بالحرية والمرونة في حياتك اليومية.
تستخدم الحركة لتجديد طاقتك ومواجهة الضغوط بثقة.""",
        "ج": """سلام الرضا الداخلي
...
تسعى دائمًا للحفاظ على التوازن النفسي في حياتك.
تمتلك قدرة على التكيف مع الظروف المختلفة والاستمتاع بالحياة."""
    }
}
...
def handle_message(event):
    ...
    if command and command != "لعبه":
        ...
        if not file_list:
            line_bot_api.reply_message(event.reply_token, TextSendMessage(text=f"لا توجد بيانات في {command}"))
            return

        idx = user_indices[command].get(user_id, global_indices[command])
        message = file_list[idx % len(file_list)]
        line_bot_api.reply_message(event.reply_token, TextSendMessage(text=message))
        user_indices[command][user_id] = idx + 1
        global_indices[command] += 1
        return
    ...
    if text.isdigit():
        num = int(text)
        if 1 <= num <= len(games_file):
            game_index = num - 1
            user_game_state[user_id] = {"game_index": game_index, "question_index": 0, "answers": []}
            first_question = games_file[game_index]["questions"][0]
    ...
    if user_id in user_game_state:
        ...
        if answer in ["أ", "ب", "ج", "1", "2", "3"]:
            ...
            game = games_file[state["game_index"]]
            ...
            if state["question_index"] < len(game["questions"]):
                ...
                game_key = list(detailed_results.keys())[state["game_index"]]
