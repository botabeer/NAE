...
# --- متابعة حالة كل مستخدم في الألعاب ---
...
أنت شخص محبوب من الجميع، وتتميز بالوفاء والإخلاص في كل علاقاتك.""",
        "ب": """قلبك نقي لكنه حذر
...
تعرف قيمة الوقت والمجهود، ولا تهدر طاقتك على من لا يستحق.""",
...
تمتلك حساسية عالية تسمح لك بالاستماع للآخرين وفهم مشاعرهم بعمق."""
    },
    "لعبة2": {
...
تمتلك قدرة على إدارة الضغوط والتعامل مع التحديات بكفاءة عالية، وتلهم من حولك بالقوة والصبر.""",
...
تقدر قيمة الروابط الاجتماعية وتعرف كيف تبني شبكة دعم قوية لنفسك ولمن حولك.""",
...
تستثمر كل تجربة لصقل شخصيتك وتحقيق النمو الداخلي المستمر."""
    },
    "لعبة3": {
        "أ": """حب الأمان والثقة
...
تمتلك القدرة على منح الحب بصدق ولكنك تتوقع الوفاء المتبادل.""",
        "ب": """حب المرح والضحك
...
تعرف كيف تجذب الآخرين بروحك المرحة وحيويتك.""",
        "ج": """حب التفاهم والدعم
...
تتمتع بقدرة على تقديم الدعم النفسي والشعور بما يحتاجه الطرف الآخر."""
    },
    "لعبة4": {
...
تمتلك قدرة على التركيز العميق وإعادة شحن طاقتك الداخلية.""",
...
تمتلك قدرة على تحويل الطاقة السلبية إلى طاقة إنتاجية وفعالة.""",
...
تتمتع بالقدرة على الإيجابية رغم كل الظروف الخارجية."""
    },
    "لعبة5": {
        "أ": """طموح شخصي مستقل
...
تمتلك عزيمة عالية تجعلك تتغلب على العقبات بروح قوية ومستقلة.""",
        "ب": """طموح اجتماعي
...
تعرف كيف تحقق الإنجازات بطريقة جماعية وتعزز روح الانتماء.""",
        "ج": """طموح مدروس وواعٍ
...
تتميز بالقدرة على اتخاذ القرارات بعقلانية وبصيرة مستقبلية."""
    },
    "لعبة6": {
...
تمتلك قدرة على تنظيم حياتك وإيجاد حلول واقعية وفعالة.""",
...
تمتلك القدرة على الجمع بين الرأي الشخصي وخبرة الآخرين لاتخاذ قرارات أفضل.""",
...
تمتلك قدرة على التقييم الشامل واتخاذ القرارات الحكيمة تحت الضغط."""
    },
    "لعبة7": {
        "أ": """صديق مخلص ومسؤول
...
تمتلك القدرة على بناء علاقات قوية ومستمرة بالاعتماد على الأمانة والثقة.""",
        "ب": """صديق مرح وممتع
...
تمتلك القدرة على جذب الآخرين بروحك المرحة وتكوين صداقات بسهولة.""",
        "ج": """صديق هادئ ومتفاهم
...
تمتلك القدرة على تقديم النصائح الحكيمة ودعم الآخرين عند الحاجة."""
    },
    "لعبة8": {
        "أ": """قرار سريع وواثق
...
تمتلك القدرة على التكيف مع الظروف واتخاذ قرارات حاسمة تحت الضغط.""",
...
تمتلك القدرة على التوفيق بين المصالح المختلفة بطريقة عادلة ومتزنة.""",
        "ج": """قرار مدروس وواعٍ
...
تمتلك القدرة على رؤية الصورة الكبيرة قبل أي خطوة لضمان النجاح."""
    },
    "لعبة9": {
        "أ": """حلم شخصي مستقل
...
تمتلك القدرة على التميز الشخصي وتحقيق إنجازات فريدة.""",
        "ب": """حلم اجتماعي
...
تمتلك القدرة على إلهام الآخرين ومساعدتهم على تحقيق أهدافهم.""",
        "ج": """حلم متوازن وواعٍ
...
تمتلك القدرة على الموازنة بين الإنجازات الفردية والمسؤوليات الاجتماعية."""
    },
    "لعبة10": {
        "أ": """سلام الانعزال الذاتي
...
تتمتع بوعي ذاتي عميق، وتعرف كيف تحافظ على صحتك النفسية.""",
        "ب": """سلام النشاط والحركة
...
تمتلك القدرة على تحويل الطاقة السلبية إلى نشاط وإنتاجية.""",
        "ج": """سلام الرضا الداخلي
...
تمتلك القدرة على إيجاد السعادة في البساطة والرضا بما لديك."""
    }
}
...
def handle_message(event):
    ...
    if command:
        if command == "سؤال":
            ...
            # إذا اللعبه، سيتم التعامل معها عبر user_game_state
            games_titles = "\n".join([
    ...
    if user_id in user_game_state:
        ...
        if answer in ["أ", "ب", "ج", "1", "2", "3"]:
            ...
            if state["question_index"] < len(game["questions"]):
                ...
                game_key = list(games_file.keys())[state["game_index"]]
