...
# ----------------- Quick Reply -----------------
def menu():
    items = ["تحليل","سؤال","اعتراف","تحدي","منشن","اقتباس","لغز"]
...
def help_flex():
    sec = [("تحليل","تحليل الشخصية"),("سؤال","أسئلة متنوعة"),("اعتراف","اعترافات جريئة"),("تحدي","تحديات ممتعة"),
           ("منشن","أسئلة منشن"),("اقتباس","حكم واقتباسات"),("لغز","ألغاز وتلميحات")]
