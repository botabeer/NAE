...
# ----------------- Quick Reply -----------------
def menu():
    items = ["تحليل","لغز","سؤال","اعتراف","تحدي","منشن","اقتباس"]
...
def help_flex():
    sec = [("تحليل","تحليل الشخصية"),("لغز","ألغاز وتلميحات"),("سؤال","أسئلة متنوعة"),("اعتراف","اعترافات جريئة"),
           ("تحدي","تحديات ممتعة"),("منشن","أسئلة منشن"),("اقتباس","حكم واقتباسات")]
